...
public class ProjectOverview extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        overview_created_date.setText(current_project.getCreate_date());
        overview_last_activity.setText(current_project.getLast_activity());
        ...
        int total_seconds=0,i;
        for(i=0;i<total_session;i++)
            total_seconds+=allSessions.get(i).minutes;
