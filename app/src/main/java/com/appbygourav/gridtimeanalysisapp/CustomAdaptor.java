...
public class CustomAdaptor extends RecyclerView.Adapter<CustomAdaptor.viewHolder> {
    ...
    @Override
    public void onBindViewHolder(@NonNull @NotNull CustomAdaptor.viewHolder holder, int position) {
        ...
        holder.recycler_last_activity.setText(p1.getLast_activity());
    }
    ...
    public class viewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public viewHolder(@NonNull @NotNull View itemView) {
            ...
            recycler_last_activity=itemView.findViewById(R.id.recycler_last_activity);
    ...
    private void loadImageFromInternal(String path,CustomAdaptor.viewHolder holder){
